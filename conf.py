...
BLOG_AUTHOR = "Jozo Gaborik"  # (translatable)
BLOG_TITLE = "Jozo"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jozo.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jozo.io/"
BLOG_EMAIL = "hi@jozo.io"
BLOG_DESCRIPTION = "Blog about python, open-source and things I care about."  # (translatable)
...
FAVICONS = (
    ...
    ("icon", "/assets/img/favicon-512x512.png", "512x512"),
)
...
# (translatable)
CONTENT_FOOTER = '<small>&copy; {date} <a href="mailto:{email}">{author}</a> - Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a> and ♥ {license}<small>'
